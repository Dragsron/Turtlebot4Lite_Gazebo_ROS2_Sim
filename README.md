...
To make the map, you can do it autonomously by "ros2 launch turtlebot4_description autonomous_mapping_launch.py" Let it run until the whole map for the world is created, save and serialize the map
